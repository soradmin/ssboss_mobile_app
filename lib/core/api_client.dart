  ...
  ..interceptors.add(
    InterceptorsWrapper(
      onRequest: (options, handler) {
        // Используем активный токен (мобильный или общий)
        ...
        if (activeToken.isNotEmpty) {
          ...
          print('[DIO] Добавлен активный токен в заголовок Authorization: ${activeToken.substring(0, 20)}...');
        } else {
          print('[DIO] Активный токен не найден, используем гостевой режим');
        }
